...
scp code.zip tgtracy@hpc-portal2.hpc.uark.edu:/home/tgtracy/code7.zip

# Wait a sec because the host is bad
sleep 1

# From pinnacle, copy to hpc
ssh tgtracy@hpc-portal2.hpc.uark.edu "scp /home/tgtracy/code7.zip tgtracy@login22:/home/tgtracy/code7.zip"
