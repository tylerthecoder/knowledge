...
int main(int argc, char *argv[]) {
  ...
  cuda_ret = cudaMalloc((void **)&inout_d, num_elements * sizeof(float));
  ...
  cuda_ret = cudaMemcpy(inout_d, in_h, num_elements * sizeof(float),
  ...
  cuda_ret = cudaMemcpy(out_h, inout_d, num_elements * sizeof(float),
